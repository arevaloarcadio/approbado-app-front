<template>
  ...
  <ion-content class="ion-padding">
    ...
    <div @click="$router.push({name : 'forum.details',params : { forum_id : comment.id} , query : {...comment }})" style="display: flex;justify-content: center;" >
      ...
      <p style="font-family: Segoe UI;width: 84px; font-style: normal;font-weight: 600;font-size: 16px;line-height: 26px;color: #000000;flex: none;order: 0;flex-grow: 0;margin-left: 11px;margin-top: 2px;">{{comment?.owner?.names}}</p>
